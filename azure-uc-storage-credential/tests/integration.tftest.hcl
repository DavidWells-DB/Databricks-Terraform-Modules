...
provider "databricks" {
  alias = "workspace"
  # host is supplied via DATABRICKS_HOST env var
}
...
variables {
  ...
  #   storage_account_id  (Azure resource ID of an ADLS Gen2 storage account)
  # Also set DATABRICKS_HOST to the workspace URL for the databricks provider.
}
