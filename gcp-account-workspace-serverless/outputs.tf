...
output "workspace_url" {
  description = "Full URL of the Databricks workspace (e.g. https://<id>.gcp.databricks.com). Use as the host for the workspace-scoped Databricks provider after DNS propagation."
